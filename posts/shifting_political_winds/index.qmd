...
presidential_votes_shift <- read_csv("posts/shifting_political_winds/post_data/presidential_votes_shift.csv") %>% 
...
#read in data
data <- read_csv("posts/shifting_political_winds/post_data/countypres_2000-2020.csv",
                 col_types = cols(
                   year = col_double(),
                   state = col_character(),
