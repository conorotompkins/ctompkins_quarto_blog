...
total_records <- read_csv("post_data/bag_full_model_results.csv") %>% 
  nrow()
```
...
train_metrics <- read_csv("post_data/train_metrics.csv")
```
...
test_metrics <- read_csv("post_data/test_metrics.csv")
```
...
model_results <- read_csv("post_data/bag_full_model_results.csv") %>%
#model_results <- read_csv("posts/house_price_estimator/data/bag_full_model_results.csv") |>
...
# geo_ids <- st_read("posts/house_price_estimator/data/unified_geo_ids/unified_geo_ids.shp",
#                    quiet = T)
