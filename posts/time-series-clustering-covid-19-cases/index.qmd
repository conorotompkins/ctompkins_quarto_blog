...
I think 12 clusters is appropriate, but there are obviously cases where individual assignments can be disputed. This is an unsupervised clustering problem, so I generally pick the `kclust` with the least diminishing returns and go with it.
