...
A plurality of commuters don't cross any rivers, and none cross three. ![](high_resolution_bar_chart.png)
...
I use the "pa_od_aux_JT00_2017.csv" file as shown here: ![](lodes_screenshot.png){width="80%" height="80%"}
...
A similar but less impactful bug affected the chloropleth chart. For completeness, this is the old verison of that graph: ![](faceted_graph.png){width="80%" height="80%"}
